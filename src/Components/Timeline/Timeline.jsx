...
export const Timeline = ({stage_id,stage_complete_status}) => {
    ...
    return (
        <div className='timeline_container'>
          ...
          {(stage_complete_status && stage_id === 1) ? <span><i class="fas fa-check"></i></span> : <span>1</span>}
          </div>  
          ...
          {(stage_complete_status && stage_id === 2) ? <span><i class="fas fa-check"></i></span> : <span>2</span>}
          </div>
          <div className="line_2">
             <img src={line} alt="line" className="line_svg" />
          </div>
          <div className="block block_3" style={{ background: block3Active ? "var(--color-gradient-2)" : 'transparent' }}>
          {(stage_complete_status && stage_id === 3) ? <span> <i class="fas fa-check"></i> </span>: <span>3</span>}   
          </div>
